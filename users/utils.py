...
##GENERAL QUERYS:
def get_number_of_sessionsRC(request):
    query_params = ''
...
def get_activities_played_counterRC(request):
    cursor = get_from_db()
    query_params = ''
...
def get_elementos_reciclados_usuario(request):
    ...
    hi = "SELECT CONCAT(usuario.nombres, ' ',usuario.apellido_paterno, ' ',usuario.apellido_materno) AS nombre,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas, elemento.nombre, pertenece.colegio_id, pertenece.curso_id FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE correcta != 2" + query_params + " GROUP BY elemento.id"
    #print(hi)
    return hi
...
def get_ElementosReciclados_Tipo(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT CONCAT(usuario.nombres, ' ',usuario.apellido_paterno, ' ',usuario.apellido_materno) AS nombre,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas, pertenece.colegio_id, pertenece.curso_id, alumno_respuesta_actividad.columna FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE correcta != 2" + query_params + " GROUP BY alumno_respuesta_actividad.columna"
    #print(hi)
    return hi
...
def get_Historial_movimientos_Sol(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT CONCAT(usuario.nombres,' ',usuario.apellido_paterno,' ',usuario.apellido_materno) AS nombre,pertenece.colegio_id,pertenece.curso_id,alumno_respuesta_actividad.correcta,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE 1=1 AND alumno_respuesta_actividad.correcta != 2 AND (alumno_respuesta_actividad.id_elemento = 290014) " + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi
def get_Historial_movimientos_Nube(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT CONCAT(usuario.nombres,' ',usuario.apellido_paterno,' ',usuario.apellido_materno) AS nombre,pertenece.colegio_id,pertenece.curso_id,alumno_respuesta_actividad.correcta,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE 1=1 AND alumno_respuesta_actividad.correcta != 2 AND (alumno_respuesta_actividad.id_elemento = 290015) " + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_movimientos_Triangulo(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT CONCAT(usuario.nombres,' ',usuario.apellido_paterno,' ',usuario.apellido_materno) AS nombre,pertenece.colegio_id,pertenece.curso_id,alumno_respuesta_actividad.correcta,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE 1=1 AND alumno_respuesta_actividad.correcta != 2 AND (alumno_respuesta_actividad.id_elemento = 290016) " + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_Reciclaje(request):
    query_params = ''
    date = ''
    query_params2 = ''
...
def get_Historial_Reciclaje_Plastico(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE alumno_respuesta_actividad.correcta != 2 AND alumno_respuesta_actividad.columna = 1" + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_Reciclaje_Carton(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE alumno_respuesta_actividad.correcta != 2 AND alumno_respuesta_actividad.columna = 2" + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_Reciclaje_Vidrio(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE alumno_respuesta_actividad.correcta != 2 AND alumno_respuesta_actividad.columna = 3" + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_Reciclaje_Metal(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE alumno_respuesta_actividad.correcta != 2 AND alumno_respuesta_actividad.columna = 4" + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    #print(hi)
    return hi

def get_Historial_Construir(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.id_elemento = 300201) AS Carretera,SUM(alumno_respuesta_actividad.id_elemento = 300202) AS Casas,SUM(alumno_respuesta_actividad.id_elemento = 300203) AS Tiendas,SUM(alumno_respuesta_actividad.id_elemento = 300204) AS Edificios,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE (alumno_respuesta_actividad.id_elemento = 300201 OR  alumno_respuesta_actividad.id_elemento = 300202 OR  alumno_respuesta_actividad.id_elemento = 300203 OR  alumno_respuesta_actividad.id_elemento = 300204) " + query_params + " GROUP BY DAY(datetime_touch) ORDER BY datetime_touch ASC"
    print(hi)
    return hi

def get_Construir_total(request):
    query_params = ''
    date = ''
    query_params2 = ''
    ...
    hi = "SELECT COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.id_elemento = 300201) AS Carretera,SUM(alumno_respuesta_actividad.id_elemento = 300202) AS Casas,SUM(alumno_respuesta_actividad.id_elemento = 300203) AS Tiendas,SUM(alumno_respuesta_actividad.id_elemento = 300204) AS Edificios,DATE(datetime_touch) as Fecha FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE (alumno_respuesta_actividad.id_elemento = 300201 OR  alumno_respuesta_actividad.id_elemento = 300202 OR  alumno_respuesta_actividad.id_elemento = 300203 OR  alumno_respuesta_actividad.id_elemento = 300204) " + query_params + ""
    #print(hi)
    return hi
...
########################################
#Timer
def get_time_act_RCOTotal(request):
    cursor = get_from_db()
    query_params = ''
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, IF (ROUND((SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))))/60<1, 1,ROUND(SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))/60)) as total_min FROM tiempoxactividad a, usuario u, pertenece b , nivel n , curso c, colegio co WHERE' + date
    final_base = ' n.id=b.nivel_id and b.curso_id = c.id and a.usuario_id = u.id and b.usuario_id=u.id and co.id = b.colegio_id' + query_params + ' and a.actividad_id > 8999 AND a.actividad_id < 9011 group by u.id;'
    print(start_base + final_base)
    return start_base + final_base
